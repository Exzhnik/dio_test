...
import 'package:lenta_api/src/model/any_ofstringinteger.dart';
...
abstract class ValidationError
  ...
  BuiltList<AnyOfstringinteger?> get loc;
    ...
    result
      ...
      ..add(serializers.serialize(object.loc,
          specifiedType: const FullType(
              BuiltList, [FullType.nullable(AnyOfstringinteger)])));
    result
      ..add(r'msg')
      ...
      switch (key) {
        case r'loc':
          final valueDes = serializers.deserialize(value,
                  specifiedType: const FullType(
                      BuiltList, [FullType.nullable(AnyOfstringinteger)]))
              as BuiltList<AnyOfstringinteger?>;
